 ...
 */
public class LoadListIsComingMeetingFromSever extends AsyncTask<String, Meetings, ArrayList<Meetings>> {
    ...
    public LoadListIsComingMeetingFromSever(Fragment mfragment) {
    ...
    protected void onPreExecute() {
        super.onPreExecute();
        recyclerView = (RecyclerView) mfragment.getActivity().findViewById(R.id.rvIsComing);
        list = new ArrayList<>();
